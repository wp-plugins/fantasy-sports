<div class="wrap">
    <h2>
        <?=!$bIsEdit ? __("Add Scoring Category", FV_DOMAIN) : __("Edit Scoring Category", FV_DOMAIN);?>
        <?php if($bIsEdit):?>
    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                <th scope="row"><?=__("Type", FV_DOMAIN);?></th>
                <td>
            ...
            <tr valign="top">
                <th scope="row"><?=__("Point");?> <span class="description">(<?=__("required", FV_DOMAIN);?>)</span></th>
                <td>
