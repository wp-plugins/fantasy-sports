...
class TableWithdrawls extends WP_List_Table
{
    ...
    function column_default( $item, $column_name ) 
    {
        ...
        { 
            ...
            case 'status':
                return $item['status'];
            case 'action':
                return '<a onclick="jQuery.admin.userWithdrawls(this, '.$item['ID'].', \'Action\')" href="#">Action</a>
    ...
    function get_sortable_columns() 
    {
        $sortable_columns = array(
            ...
            'new_balance'  => array('balance',false),
    ...
    function prepare_items($keyword = null) 
    {
        ...
        //get data
        list($total_items, $this->data) = self::$user->getUsersWithdrawls($aCond, 'ID ASC', ($this->get_pagenum() - 1) * $item_per_page, $item_per_page);
